 ...
 * </p>
 * <ul>
 *   <li>{@link metamind.ecore.metamind.impl.ChunkImpl#getName <em>Name</em>}</li>
 *   <li>{@link metamind.ecore.metamind.impl.ChunkImpl#getSlot <em>Slot</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ChunkImpl extends MinimalEObjectImpl.Container implements Chunk {
	...
	protected EClass eStaticClass() {
		return MetamindPackage.Literals.CHUNK;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MetamindPackage.CHUNK__NAME, oldName, name));
	}
	...
	public EList<Slot> getSlot() {
		if (slot == null) {
			slot = new EObjectContainmentEList<Slot>(Slot.class, this, MetamindPackage.CHUNK__SLOT);
		}
		return slot;
	}
