 ...
 * @generated
 */
public class MetamindSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case MetamindPackage.MODULE: {
			metamind.ecore.metamind.Module module = (metamind.ecore.metamind.Module) theEObject;
		...
		case MetamindPackage.DECLARATIVE_MEMORY: {
			DeclarativeMemory declarativeMemory = (DeclarativeMemory) theEObject;
			T result = caseDeclarativeMemory(declarativeMemory);
			if (result == null)
				result = caseModule(declarativeMemory);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case MetamindPackage.PROCEDURAL_MEMORY: {
			ProceduralMemory proceduralMemory = (ProceduralMemory) theEObject;
			T result = caseProceduralMemory(proceduralMemory);
			if (result == null)
				result = caseModule(proceduralMemory);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		...
		case MetamindPackage.WORKING_MEMORY: {
			WorkingMemory workingMemory = (WorkingMemory) theEObject;
			T result = caseWorkingMemory(workingMemory);
			if (result == null)
				result = caseModule(workingMemory);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
	 ...
	 * @generated
	 */
	public T caseModule(metamind.ecore.metamind.Module object) {
		return null;
	}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Declarative Memory</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Declarative Memory</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseDeclarativeMemory(DeclarativeMemory object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>Procedural Memory</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Procedural Memory</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseProceduralMemory(ProceduralMemory object) {
		return null;
	}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Working Memory</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Working Memory</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseWorkingMemory(WorkingMemory object) {
		return null;
	}
