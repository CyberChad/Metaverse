...
/**
 * This is the item provider adapter for a {@link metamind.ecore.metamind.Module} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ModuleItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						MetamindPackage.Literals.MODULE__NAME, true, false, false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(MetamindPackage.Literals.MODULE__BUFFER);
		}
	...
	public String getText(Object object) {
		String label = ((metamind.ecore.metamind.Module) object).getName();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(metamind.ecore.metamind.Module.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(MetamindPackage.Literals.MODULE__BUFFER,
				MetamindFactory.eINSTANCE.createBuffer()));
	}
