...
/**
 * This is the item provider adapter for a {@link metamind.ecore.metamind.Rule} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RuleItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						MetamindPackage.Literals.RULE__NAME, true, false, false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(MetamindPackage.Literals.RULE__CONDITIONS);
			childrenFeatures.add(MetamindPackage.Literals.RULE__ACTIONS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(MetamindPackage.Literals.RULE__CONDITIONS,
				MetamindFactory.eINSTANCE.createCondition()));

		newChildDescriptors.add(
				createChildParameter(MetamindPackage.Literals.RULE__ACTIONS, MetamindFactory.eINSTANCE.createAction()));
	}
