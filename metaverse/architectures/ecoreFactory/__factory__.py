...
import metaverse.metamind as metamind
import metaverse.metamind.Model
...
# from metamind import DeclarativeMemory
# from metamind import ProceduralMemory
...
# from metamind import WorkingMemory
...
class Metamindfactory:
	...
	def createBuffer(self):
		...
		# type here special initialization code
		return instance
	def createDeclarativeMemory(self):
		"""
		Create an instance of DeclarativeMemory.
		"""
		instance = DeclarativeMemory()
		# type here special initialization code
		return instance
	def createProceduralMemory(self):
		"""
		Create an instance of ProceduralMemory.
		"""
		instance = ProceduralMemory()
		# type here special initialization code
		return instance
	...
	def createAction(self):
		...
		# type here special initialization code
		return instance
	def createWorkingMemory(self):
		"""
		Create an instance of WorkingMemory.
		"""
...
class Test_metamind_factory(unittest.TestCase):
	...
	def testDeclarativeMemoryCreation(self):
		"""
		Test the direct instanciation of a DeclarativeMemory.
		"""
		d = DeclarativeMemory()
		self.assertTrue(d!=None)

	def testDeclarativeMemoryCreationFactory(self):
		"""
		Test the instanciation of a DeclarativeMemory through the factory.
		"""
		factory = Metamindfactory()
		d = factory.create("DeclarativeMemory")
		self.assertTrue(d != None)
		self.assertTrue(isinstance(d, DeclarativeMemory))
	def testProceduralMemoryCreation(self):
		"""
		Test the direct instanciation of a ProceduralMemory.
		"""
		d = ProceduralMemory()
		self.assertTrue(d!=None)

	def testProceduralMemoryCreationFactory(self):
		"""
		Test the instanciation of a ProceduralMemory through the factory.
		"""
		factory = Metamindfactory()
		d = factory.create("ProceduralMemory")
		self.assertTrue(d != None)
		self.assertTrue(isinstance(d, ProceduralMemory))
	...
	def testWorkingMemoryCreation(self):
		"""
		Test the direct instanciation of a WorkingMemory.
		"""
		d = WorkingMemory()
		self.assertTrue(d!=None)

	def testWorkingMemoryCreationFactory(self):
		"""
		Test the instanciation of a WorkingMemory through the factory.
		"""
		factory = Metamindfactory()
		d = factory.create("WorkingMemory")
		self.assertTrue(d != None)
		self.assertTrue(isinstance(d, WorkingMemory))
