...
public class MetamindSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case MetamindPackage.MODULE: {
				metamind.Module module = (metamind.Module)theEObject;
			...
			case MetamindPackage.DECLARATIVE_MEMORY: {
				...
				if (result == null) result = caseModule(declarativeMemory);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case MetamindPackage.PROCEDURAL_MEMORY: {
				...
				if (result == null) result = caseModule(proceduralMemory);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case MetamindPackage.MOTOR: {
				...
				if (result == null) result = caseModule(motor);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case MetamindPackage.VISUAL: {
				...
				if (result == null) result = caseModule(visual);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case MetamindPackage.WORKING_MEMORY: {
				...
				if (result == null) result = caseModule(workingMemory);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	 ...
	 * @generated
	 */
	public T caseModule(metamind.Module object) {
		return null;
	}
